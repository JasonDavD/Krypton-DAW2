 ...
 *
 * <p>Trimmeado para catalog-service: solo maneja excepciones de catálogo
 * (SKU/categoría/recurso), validación, 500 genérico de storage y el límite de
 * tamaño de upload. Las excepciones de otros dominios (usuarios, órdenes, pago)
 * viven en sus respectivos servicios.
 */
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleInsufficientStock(InsufficientStockException ex) {
        // 422: el request es válido pero no se puede procesar (no hay stock). Lo consume el
        // checkout distribuido (order-service vía Feign) para abortar y compensar.
